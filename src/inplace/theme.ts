...
export const inPlaceTheme = EditorView.theme({
  ...
  ".cm-inplace-table-wrap:hover .cm-inplace-tg-edge": { opacity: "1" },
  // right edge → add column; bottom edge → add row. Click anywhere along it.
  ".cm-inplace-tg-addcol": { width: "0.9em", transform: "translateX(4px)" },
  ".cm-inplace-tg-addrow": { height: "0.9em", transform: "translateY(4px)" },
  ".cm-inplace-tg-edge:hover": {
    background: "color-mix(in srgb, var(--stylo-ring) 12%, transparent)",
  },
  ".cm-inplace-tg-plus": {
    position: "absolute",
    display: "flex",
  ...
  ".cm-inplace-tg-addcol .cm-inplace-tg-plus": { left: "50%", top: "50%" },
  ".cm-inplace-tg-addrow .cm-inplace-tg-plus": { top: "50%", left: "50%" },
  ".cm-inplace-tg-edge:hover .cm-inplace-tg-plus": {
